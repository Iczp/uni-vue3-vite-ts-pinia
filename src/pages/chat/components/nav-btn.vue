...
.btn-item {
  ...
  border-right: 0;
  height: 52rpx;
  background-image: linear-gradient(180deg, rgba(255, 255, 255, 0.6), rgba(233, 233, 233, 0.8));
}
...
.btn-item:hover {
  background-image: linear-gradient(0deg, rgba(255, 255, 255, 0.6), rgba(233, 233, 233, 0.8));
}
</style>
