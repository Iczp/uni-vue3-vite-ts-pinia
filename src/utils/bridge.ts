  ...
  new Promise<InvokeResult>((resolve, reject) => {
    ...
    try {
      ...
      uni.$once(event, (...args) => {
        ...
        var obj = jsonParse(args) as InvokeResult;
...
export const getSystemInfo = (...args) => invoke({
	action: 'uni.getSystemInfo',
	args,
})

export const setNavigationBarColor = (...args) => invoke({
	action: 'uni.setNavigationBarColor',
	args,
})

export const setNavigationBarTitle = (...args) => invoke({
	action: 'uni.setNavigationBarTitle',
	args,
})

export const scanCode = (...args) => invoke({
	action: 'uni.scanCode',
	args,
})


export const navigateBack = (...args) => invoke({
	action: 'uni.navigateBack',
	args,
})

export const getAuth = (...args) => invoke({
	action: 'auth',
	args,
})

export const chooseImage = (...args) => invoke({
...
export const navToWebview = (...args) => invoke({
	action: 'navToWebview',
	args,
})


export const $emit = (...args) => invoke({
	action: 'uni.$emit',
	args,
})
export const $on = (...args) => invoke({
	action: 'uni.$on',
	args,
})
export const $once = (...args) => invoke({
	action: 'uni.$once',
	args,
})
